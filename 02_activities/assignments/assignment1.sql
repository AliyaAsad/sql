...
SELECT v.vendor_id, v.vendor_name, COUNT(*)count_boothrentals
FROM vendor AS v
...
CREATE TEMP TABLE temp.new_vendor AS SELECT * FROM vendor; -- part 1 of 2 queries

INSERT INTO temp.new_vendor 
VALUES (10, "Thomass Superfood Store", "Fresh Focused", "Thomas", "Rosenthal");  -- part 2 of 2 queries

SELECT * FROM temp.new_vendor -- to veiw the new temp table
